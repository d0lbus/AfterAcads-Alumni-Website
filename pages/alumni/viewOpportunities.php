...
<head>
  ...
  <title>Job Opportunity - View</title>
  <link rel="stylesheet" href="https://maxst.icons8.com/vue-static/landings/line-awesome/line-awesome/1.3.0/css/line-awesome.min.css" />
  <link rel="stylesheet" href="../../style/alumni/view-opportunities.css" />
  ...
  <div class="main-content">
    ...
    <main>
      <div class="page-header">
        ...
        <small>{Details about the job you are interested in}</small>
        ...
        <div class="job-detail-container">
          <div class="job-detail">
            ...
            <div class="job-details">
              <h2>Software Engineer</h2> <!-- Job Title -->
              <p><strong>Company:</strong> {XYZ Corp}</p>
              <p><strong>Location:</strong> {LOCATION}</p>
              <p><strong>Description:</strong> {DESCIPTION}</p>
              <p><strong>Requirements:</strong> {REQUIREMENTS}</p>
              <p><strong>How to Apply:</strong> Send your resume and cover letter to <a href="">{EMAIL}</a>.</p>
            </div>
            <div class="button-container">
              <a href="apply.php?job_id=1" class="button">APPLY NOW</a>
            </div>
          </div>
        </div>
      </div>
